...
class Admin
{
    ...
    public function enqueueStyles(string $hook): void
    {
        ...
        $styleFileName = ($this->settings->getDebug() === true) ? 'tmsm-aquatonic-memberarea-admin.css' : 'tmsm-aquatonic-memberarea-admin.min.css';
    ...
    public function enqueueScripts(string $hook): void
    {
        ...
        $scripFileName = ($this->settings->getDebug() === true) ? 'tmsm-aquatonic-memberarea-admin.js' : 'tmsm-aquatonic-memberarea-admin.min.js';
