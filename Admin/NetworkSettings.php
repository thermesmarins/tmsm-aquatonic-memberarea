...
class NetworkSettings extends SettingsBase
{
    ...
    public function initializeHooks(bool $isNetworkAdmin): void
    {
        ...
        if ($isNetworkAdmin)
        {
            ...
            add_action('network_admin_edit_tmsm_aquatonic_memberarea_update_network_options', array($this, 'tmsm_aquatonic_memberarea_update_network_options'));
        }
    }
    ...
    public function setupNetworkSettingsMenu(): void
    {
        ...
        add_menu_page(
            'Tmsm Aquatonic Memberarea Network Options',                      // Page title: The title to be displayed in the browser window for this page.
        ...
        add_settings_section(
            ...
            __('Network General', 'tmsm-aquatonic-memberarea'),           // Title to be displayed on the administration page
    ...
    public function renderNetworkSettingsPageContent(string $activeTab = ''): void
    {
        ...
        <div class="wrap">
            ...
            <h2><?php esc_html_e('Tmsm Aquatonic Memberarea Network Options', 'tmsm-aquatonic-memberarea'); ?></h2>
            ...
            <h2 class="nav-tab-wrapper">
                ...
                <a href="?page=<?php echo $this->menuSlug; ?>&tab=examples" class="nav-tab <?php echo $activeTab === 'examples' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Examples', 'tmsm-aquatonic-memberarea'); ?></a>
            </h2>

            <form method="post" action="edit.php?action=tmsm_aquatonic_memberarea_update_network_options">
                <?php
     ...
     */
    public function tmsm_aquatonic_memberarea_update_network_options()
    {
        // Security check.
        ...
        {
            wp_die(__('Failed security check.', 'tmsm-aquatonic-memberarea'));
        }
...
#region GENERAL OPTIONS
    ...
    public function networkGeneralOptionsCallback(): void
    {
        ...
        echo '<p>' . esc_html__('Network General Options.', 'tmsm-aquatonic-memberarea') . '</p>';
    }
