...
namespace TmsmAquatonicMemberarea\Admin;

use TmsmAquatonicMemberarea\Admin\SettingsBase;
 ...
 * @subpackage TmsmAquatonicMemberarea/Admin
 */
class Settings extends SettingsBase
{
    ...
    public function setupSettingsMenu(): void
    {
        ...
        add_menu_page(
            'Tmsm Aquatonic Memberarea Options',                      // Page title: The title to be displayed in the browser window for this page.
            'Tmsm Aquatonic Memberarea',                              // Menu title: The text to be used for the menu.
    ...
    public function renderSettingsPageContent(string $activeTab = ''): void
    {
        ...
        <div class="wrap">
            ...
            <h2><?php esc_html_e('Tmsm Aquatonic Memberarea Options', 'tmsm-aquatonic-memberarea'); ?></h2>

            <?php $activeTab = isset($_GET['tab']) ? $_GET['tab'] : 'general_options'; ?>

            <h2 class="nav-tab-wrapper">
                <a href="?page=<?php echo $this->menuSlug; ?>&tab=general_options" class="nav-tab <?php echo $activeTab === 'general_options' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('General', 'tmsm-aquatonic-memberarea'); ?></a>
                <a href="?page=<?php echo $this->menuSlug; ?>&tab=input_examples" class="nav-tab <?php echo $activeTab === 'input_examples' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Input Examples', 'tmsm-aquatonic-memberarea'); ?></a>
            </h2>
...
#region GENERAL OPTIONS
    ...
    public function initializeGeneralOptions(): void
    {
        ...
        add_settings_section(
            ...
            __('General', 'tmsm-aquatonic-memberarea'),               // Title to be displayed on the administration page
        ...
        add_settings_field(
            ...
            __('Debug', 'tmsm-aquatonic-memberarea'),            // The label to the left of the option interface element.
    ...
    public function generalOptionsCallback(): void
    {
        ...
        echo '<p>' . esc_html__('General options.', 'tmsm-aquatonic-memberarea') . '</p>';
    }
...
#region INPUT EXAMPLES OPTIONS
    ...
    public function initializeInputExamples(): void
    {
        ...
        add_settings_section($this->exampleSettingsSectionId, __('Input Examples', 'tmsm-aquatonic-memberarea'), array($this, 'inputExamplesCallback'), $this->examplePage);

        add_settings_field($this->textExampleId, __('Input Element', 'tmsm-aquatonic-memberarea'), array($this, 'inputElementCallback'), $this->examplePage, $this->exampleSettingsSectionId, array('label_for' => $this->textExampleId));

        add_settings_field($this->textareaExampleId, __('Textarea Element', 'tmsm-aquatonic-memberarea'), array($this, 'textareaElementCallback'), $this->examplePage, $this->exampleSettingsSectionId, array('label_for' => $this->textareaExampleId));

        add_settings_field($this->checkboxExampleId, __('Checkbox Element', 'tmsm-aquatonic-memberarea'), array($this, 'checkboxElementCallback'), $this->examplePage, $this->exampleSettingsSectionId, array('label_for' => $this->checkboxExampleId));

        add_settings_field($this->radioExampleId, __('Radio Button Elements', 'tmsm-aquatonic-memberarea'), array($this, 'radioElementCallback'), $this->examplePage, $this->exampleSettingsSectionId, array('label_for' => $this->radioExampleId));

        add_settings_field($this->selectExampleId, __('Select Element', 'tmsm-aquatonic-memberarea'), array($this, 'selectElementCallback'), $this->examplePage, $this->exampleSettingsSectionId, array('label_for' => $this->selectExampleId));
    ...
    public function inputExamplesCallback(): void
    {
        ...
        echo '<p>' . esc_html__('Provides examples of the five basic element types.', 'tmsm-aquatonic-memberarea') . '</p>';
    }
    ...
    public function selectElementCallback(): void
    {
        ...
        $html .= '<option value="default">' . esc_html__('Select a time option...', 'tmsm-aquatonic-memberarea') . '</option>';
        $html .= sprintf('<option value="never" %s >%s</option>', selected($this->exampleOptions[$this->selectExampleId], 'never', false), esc_html__('Never', 'tmsm-aquatonic-memberarea'));
        $html .= sprintf('<option value="sometimes" %s >%s</option>', selected($this->exampleOptions[$this->selectExampleId], 'sometimes', false), esc_html__('Sometimes', 'tmsm-aquatonic-memberarea'));
        $html .= sprintf('<option value="always" %s >%s</option>', selected($this->exampleOptions[$this->selectExampleId], 'always', false), esc_html__('Always', 'tmsm-aquatonic-memberarea'));
        $html .= '</select>';
