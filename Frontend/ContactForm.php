...
class ContactForm
{
    ...
    {
        $html = '<div>
                    <label for="capitalized-subject">' . esc_html__('Capizalized subject (value is reveived from a PHP function)', 'tmsm-aquatonic-memberarea') . '</label>
                    ...
                    <form action="' . esc_url($_SERVER['REQUEST_URI']) . '" method="post">
                        ...
                        <p>
                            <label for="subject">' . esc_html__('Subject', 'tmsm-aquatonic-memberarea') . '&nbsp;<span class="required">*</span></label>
                            <input type="text" id="subject" name="subject" value="' . (isset($_POST["subject"]) ? esc_html($_POST["subject"]) : '') . '" required />
                        </p>
                        <p>
                            <label for="body">' . esc_html__('Body', 'tmsm-aquatonic-memberarea') . '&nbsp;<span class="required">*</span></label>
