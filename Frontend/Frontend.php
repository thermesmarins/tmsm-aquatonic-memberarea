 ...
 * @subpackage TmsmAquatonicMemberarea/Frontend
...
class Frontend
{
    ...
    public function enqueueStyles(): void
    {
        ...
        $styleFileName = ($this->settings->getDebug() === true) ? 'tmsm-aquatonic-memberarea-frontend.css' : 'tmsm-aquatonic-memberarea-frontend.min.css';
    ...
    public function enqueueScripts(): void
    {
        ...
        $scripFileName = ($this->settings->getDebug() === true) ? 'tmsm-aquatonic-memberarea-frontend.js' : 'tmsm-aquatonic-memberarea-frontend.min.js';
        ...
        {
            exit(esc_html__('Script could not be registered: ', 'tmsm-aquatonic-memberarea') . $scriptUrl);
        }
         ...
         */
        $contactFormScripFileName = ($this->settings->getDebug() === true) ? 'tmsm-aquatonic-memberarea-contact-form.js' : 'tmsm-aquatonic-memberarea-contact-form.min.js';
