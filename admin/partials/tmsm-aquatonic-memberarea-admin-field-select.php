...
?><select
	aria-label="<?php esc_attr( _e( $atts['aria'], 'tmsm-aquatonic-memberarea' ) ); ?>"
...
if ( ! empty( $atts['blank'] ) ) {
	...
	?><option value><?php esc_html_e( $atts['blank'], 'tmsm-aquatonic-memberarea' ); ?></option><?php
...
foreach ( $atts['selections'] as $selection ) {
	...
	?><option
		...
		esc_html_e( $label, 'tmsm-aquatonic-memberarea' );
